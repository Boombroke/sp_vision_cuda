/**
 * 与 tests/auto_aim_test.cpp 流程一致：视频 + 姿态 txt、Solver / Tracker / Aimer / Plotter，
 * 检测端使用 tasks/auto_aim/yolos/yolov5_trt（TensorRT RP）。
 *
 * 需 -DBOF_WITH_INFER=ON；配置见 configs/auto_aim_trt_test.yaml（在 demo 基础上增加 TRT 引擎路径）。
 */
...
const std::string keys =
  ...
  "{config-path c  | configs/auto_aim_trt_test.yaml | yaml配置文件的路径}"
